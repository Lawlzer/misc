	...
	overrides: [
		{
			...
			rules: {
				...
				// // When tabbing, it will automatically error if you have tabs/spaces (This is by Prettier)
				// 'no-trailing-spaces': 'error',
				// // 'no-trailing-spaces': 'off',

				// // Error if something is implicitly defined as :any (this is bad!)
