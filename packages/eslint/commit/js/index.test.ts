import { ensureDirectoryExists } from '@lawlzer/utils';
...
describe(`eslint/commit/js`, () => {
	...
	// 		const tempFolderPath = path.join(process.cwd(), 'temp', 'test', 'eslint', 'commit', 'js');
	...
	// 			module.exports = {
	// 				extends: ['./node_modules/@lawlzer/eslint/commit/js/index.js'],
	// 				root: true,
	// 			  };
	// 	`;
